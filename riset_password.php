...
<body id="page-top" >
    ...
    <div class="card mt-3 border border-dark rounded-0">
      <div class="card-body m-0 p-0">
            <div class="row align-items-center">
              ...
              <h3 class="mb-2"><b>RISET || <a href="index.php" style="text-decoration:none; color: #e97770;">CINEMASTAR</a></b></h3>
              <form action="model/risetpassword_model.php" method="POST" id="form-pelanggan" enctype="multipart/form-data">
  ...
  <script type="text/javascript">
    $('#my-button').click(function() {
        if ($('#ulang_password').val().length == 0 || $('#password').val().length == 0 || $('#password').val().length !== $('#ulang_password').val().length) {
