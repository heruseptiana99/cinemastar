				...
				<div id="content">
					<article class="box post">
						...
						<p>
							...
							Untuk menyempurnakan pelayanan kepada reviewers, kami selalu akan terus berbenah menjadi yang terbaik
						</p>
						<p>
							Dengan CinemaStar anda dapat meriview film dengan memecah sebuah karya (film) ke dalam penilaian atas unsur-unsurnya seperti cerita, penyutradaraan, akting, musik, setting, alur, suasana dan lain lain. CinemaStar hadir sebagai bentuk solusi dari permasalahan masyarakat yang ragu saat ingin menonton sebuah film, dikarenakan jika hanya mengandalkan trailler saja tidak cukup.
