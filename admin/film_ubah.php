                                        ...
                                        <form action="film_proses_ubah.php?id_film=<?= $id_film ?>" method="POST" id="form-pelanggan" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="rating" name="rating">
                                                    <option value="SU" <?php if ($rating == "SU") {
                                                    echo "selected";
                                                    } ?>>SU</option>
                                                    <option value="BO" <?php if ($rating == "BO") {
                                                    echo "selected";
                                                    } ?>>BO</option>
                                                    <option value="BO +4" <?php if ($rating == "BO +4") {
                                                    echo "selected";
                                                    } ?>>BO +4</option>
                                                    <option value="BO +13" <?php if ($rating == "BO +13") {
                                                    echo "selected";
                                                    } ?>>BO +13</option>
                                                    <option value="D" <?php if ($rating == "D") {
                                                    echo "selected";
                                                    } ?>>D</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="jenis_tayang" name="jenis_tayang">
                                                    <option value="Tayang hari ini" <?php if ($jenis_tayang == "Tayang hari ini") {
                                                    echo "selected";
                                                    } ?>>Tayang hari ini</option>
                                                    <option value="Coming soon" <?php if ($jenis_tayang == "Coming soon") {
                                                    echo "selected";
                                                    } ?>>Coming soon</option>
                                                    <option value="Tidak tayang" <?php if ($jenis_tayang == "Tidak tayang") {
                                                    echo "selected";
                                                    } ?>>Tidak tayang</option>
                                                </select>
                                            </div>
