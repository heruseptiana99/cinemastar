                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form action="film_proses_tambah.php" method="POST" id="form-pelanggan" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="rating" name="rating">
                                            ...
                                            <option value="BO +4">BO +4</option>
                                            <option value="BO +13">BO +13</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="jenis_tayang" name="jenis_tayang">
                                            <option value="Tayang hari ini">Tayang hari ini</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="link_trailer" name="link_trailer" placeholder="Link Trailer">
                                        <small id="text-error-link_trailer"></small>
                                    </div>
                                    <div class="form-group">
                                        <label for="tgl_tayang">Tanggal Tayang</label>
                                        <input type="date" class="form-control" id="tgl_tayang" name="tgl_tayang">
                                        <small id="text-error-tgl_tayang"></small>
                                    </div>
                                    <div class="form-group">
                                        <label for="sinopsis">Sinopsis</label>
                                        <textarea name="sinopsis" id="sinopsis" class="form-control" rows="10"></textarea>
                                        <small id="text-error-sinopsis"></small>
                                    </div>
                                    <button id="my-button" type="button" class="btn btn-primary mt-3">Tambah Film</button>
