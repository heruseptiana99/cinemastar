                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">TAMBAH SUTRADARA FILM</h1>
                        </div>
                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Data Sutradara Film</h6>
                            </div>
                            <div class="card-body">
                                <?php
                                ...
                                <form action="film_proses.php?id_film=<?= $id_film ?>" method="POST" id="form-pelanggan" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <input type="hidden" name="aksi" value="tambah_sutradara">
                                        <label for="id_sutradara">sutradara</label>
                                        <select class="form-control" id="id_sutradara" name="id_sutradara">
                                            <?php
                                            include('connect.php');
                                            $data_sutradara = mysqli_query($conn, "SELECT * FROM sutradara");
                                            while ($sutradara = mysqli_fetch_array($data_sutradara)) {
                                            ?>
                                                <option value="<?= $sutradara['id_sutradara'] ?>"><?= $sutradara['nama'] ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
